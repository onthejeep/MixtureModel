...
def ExecuteTraining(dataSize):
    ...
    MeanVarFile = open('Tensorflow/Result/result_meanvar_{}_{}.csv'.format(Optimizer._Distribution, dataSize), 'w+', newline = '');
    MuSigmaFile = open('Tensorflow/Result/result_musigma_{}_{}.csv'.format(Optimizer._Distribution, dataSize), 'w+', newline = '');
